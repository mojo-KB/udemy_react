...
type SkillLevel =  "Beginner" | "Intermediate" | "Advanced" | "Expert"  = 'Beginner';
// **********************************************
// ******************* PART 4 *******************
// **********************************************
...
const greet(inputString: string[] | string): void => {
    if(typeof inputString === "string") {
        console.log(`print{Hello, ${inputString}}`)
    } else {
        inputString?.map(string => {
            console.log(`print{Hello, ${string}}`)
        }) 
    }
}